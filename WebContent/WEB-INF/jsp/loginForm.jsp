...
<form action="/sukkiriShop/LoginServlet" method="post" class="blueborder">
	<div class="form-group">
		<label><dl>
			<dt>ユーザーID：</dt>
			<dd><input type="text" class="form-control" placeholder="必須項目です" name="userID" pattern="^([a-zA-Z0-9]{8,})$" required></dd>
	...
	<div class="form-group">
		<label><dl>
			<dt>パスワード：</dt>
			<dd><input type="password" class="form-control" placeholder="必須項目です" name="userPass" pattern="^([a-zA-Z0-9]{8,})$" required></dd>
			<%-- <dd><small class="form-text text-muted">※半角で8文字以上で入力してください</small></dd> --%>
		</dl></label>
	</div>
